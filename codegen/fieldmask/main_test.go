...
func TestFastWrite_WhiteList(t *testing.T) {
...
func TestFastWrite_BlackList(t *testing.T) {
	var obj = SampleNewBase()
	// Load fieldmask from cache
...
func TestFastRead_WhiteList(t *testing.T) {
	obj := SampleNewBase()
...
func TestFastRead_BlackList(t *testing.T) {
	obj := SampleNewBase()
	buf := make([]byte, obj.BLength())
	e := obj.FastWriteNocopy(buf, nil)
	obj2 := nbase.NewBase()
