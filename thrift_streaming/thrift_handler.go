...
func (e EchoServiceImpl) EchoBidirectional(stream echo.EchoService_EchoBidirectionalServer) (err error) {
	klog.Infof("EchoBidirectional: start")
	count := GetInt(stream.Context(), KeyCount, 0)
	if count == 0 {
		return errors.New("count not set in metadata")
	}
...
func (e EchoServiceImpl) EchoServer(req *echo.EchoRequest, stream echo.EchoService_EchoServerServer) (err error) {
...
func (e EchoServiceImpl) EchoUnary(ctx context.Context, req1 *echo.EchoRequest) (r *echo.EchoResponse, err error) {
...
func (e EchoServiceImpl) EchoPingPong(ctx context.Context, req1, req2 *echo.EchoRequest) (r *echo.EchoResponse, err error) {
...
func (e EchoServiceImpl) EchoOneway(ctx context.Context, req1 *echo.EchoRequest) (err error) {
...
func (e EchoServiceImpl) Ping(ctx context.Context) (err error) {
	err = GetError(ctx)
