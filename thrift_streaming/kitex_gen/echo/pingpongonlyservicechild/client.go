...
func NewClient(destService string, opts ...client.Option) (Client, error) {
	...
	return &kPingPongOnlyServiceChildClient{
...
type kPingPongOnlyServiceChildClient struct {
	*kClient
}

func (p *kPingPongOnlyServiceChildClient) EchoPingPongNew(ctx context.Context, req1 *echo.EchoRequest, callOptions ...callopt.Option) (r *echo.EchoResponse, err error) {
...
func NewStreamClient(destService string, opts ...streamclient.Option) (StreamClient, error) {
	...
	return &kPingPongOnlyServiceChildStreamClient{
		kClient: newServiceClient(kc),
	}, nil
}
...
type kPingPongOnlyServiceChildStreamClient struct {
	*kClient
}

func (p *kPingPongOnlyServiceChildStreamClient) EchoBidirectionalExtended(ctx context.Context, callOptions ...streamcall.Option) (stream PingPongOnlyServiceChild_EchoBidirectionalExtendedClient, err error) {
