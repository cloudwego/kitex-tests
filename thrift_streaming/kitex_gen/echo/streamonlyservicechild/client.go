...
func NewClient(destService string, opts ...client.Option) (Client, error) {
	...
	return &kStreamOnlyServiceChildClient{
...
type kStreamOnlyServiceChildClient struct {
	*kClient
}
...
func NewStreamClient(destService string, opts ...streamclient.Option) (StreamClient, error) {
	...
	return &kStreamOnlyServiceChildStreamClient{
		kClient: newServiceClient(kc),
	}, nil
}
...
type kStreamOnlyServiceChildStreamClient struct {
	*kClient
}

func (p *kStreamOnlyServiceChildStreamClient) EchoBidirectionalNew(ctx context.Context, callOptions ...streamcall.Option) (stream StreamOnlyService_EchoBidirectionalNewClient, err error) {
