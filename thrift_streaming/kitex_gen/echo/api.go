...
func (p *ABCServiceClient) EchoBidirectional(stream ABCService_EchoBidirectionalServer) (err error) {
	panic("streaming method ABCService.EchoBidirectional(mode = bidirectional) not available, please use Kitex Thrift Streaming Client.")
}
...
func (p *ABCServiceClient) EchoServer(req *c.Request, stream ABCService_EchoServerServer) (err error) {
	panic("streaming method ABCService.EchoServer(mode = server) not available, please use Kitex Thrift Streaming Client.")
}
...
func (p *ABCServiceClient) EchoClient(stream ABCService_EchoClientServer) (err error) {
	panic("streaming method ABCService.EchoClient(mode = client) not available, please use Kitex Thrift Streaming Client.")
}
...
func (p *ABCServiceClient) EchoUnary(ctx context.Context, req1 *c.Request) (r *c.Response, err error) {
	panic("streaming method ABCService.EchoUnary(mode = unary) not available, please use Kitex Thrift Streaming Client.")
}
...
func (p *LowerServiceClient) EchoBidirectional(stream LowerService_echo_bidirectionalServer) (err error) {
	panic("streaming method LowerService.echo_bidirectional(mode = bidirectional) not available, please use Kitex Thrift Streaming Client.")
}
...
func (p *LowerServiceClient) EchoClient(stream LowerService_echo_clientServer) (err error) {
	panic("streaming method LowerService.echo_client(mode = client) not available, please use Kitex Thrift Streaming Client.")
}
...
func (p *LowerServiceClient) EchoServer(req *LowerRequest, stream LowerService_echo_serverServer) (err error) {
	panic("streaming method LowerService.echo_server(mode = server) not available, please use Kitex Thrift Streaming Client.")
}
...
func (p *LowerServiceClient) EchoUnary(ctx context.Context, req1 *LowerRequest) (r *LowerResponse, err error) {
	panic("streaming method LowerService.echo_unary(mode = unary) not available, please use Kitex Thrift Streaming Client.")
}
