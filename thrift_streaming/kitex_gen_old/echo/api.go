...
func (p *StreamOnlyServiceClient) EchoBidirectional(ctx context.Context, req1 *EchoRequest) (r *EchoResponse, err error) {
	var _args StreamOnlyServiceEchoBidirectionalArgs
	_args.Req1 = req1
	var _result StreamOnlyServiceEchoBidirectionalResult
	if err = p.Client_().Call(ctx, "EchoBidirectional", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
...
func (p *streamOnlyServiceProcessorEchoBidirectional) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := StreamOnlyServiceEchoBidirectionalArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("EchoBidirectional", thrift.EXCEPTION, seqId)
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := StreamOnlyServiceEchoBidirectionalResult{}
	var retval *EchoResponse
	if retval, err2 = p.handler.EchoBidirectional(ctx, args.Req1); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing EchoBidirectional: "+err2.Error())
		oprot.WriteMessageBegin("EchoBidirectional", thrift.EXCEPTION, seqId)
