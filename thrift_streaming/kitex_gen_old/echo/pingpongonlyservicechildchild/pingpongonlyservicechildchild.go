...
func serviceInfo() *kitex.ServiceInfo {
	return pingPongOnlyServiceChildChildServiceInfo
}

var pingPongOnlyServiceChildChildServiceInfo = NewServiceInfo()

func NewServiceInfo() *kitex.ServiceInfo {
	serviceName := "PingPongOnlyServiceChildChild"
	handlerType := (*echo.PingPongOnlyServiceChildChild)(nil)
