...
func (p *kStreamOnlyServiceChildClient) EchoBidirectionalNew(ctx context.Context, req1 *echo.EchoRequest, callOptions ...callopt.Option) (r *echo.EchoResponse, err error) {
