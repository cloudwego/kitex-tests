...
type kServiceCClient struct {
	*kClient
}

func (p *kServiceCClient) EchoC(ctx context.Context, callOptions ...callopt.Option) (stream ServiceC_EchoCClient, err error) {
...
type kServiceCStreamClient struct {
	*kClient
}

func (p *kServiceCStreamClient) EchoC(ctx context.Context, callOptions ...streamcall.Option) (stream ServiceC_EchoCClient, err error) {
