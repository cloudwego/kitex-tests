...
import (
	...
	"errors"
	"fmt"
	pbapi "github.com/cloudwego/kitex-tests/kitex_gen/protobuf/pbapi"
...
func unaryTestHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(pbapi.MockReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(pbapi.Mock).UnaryTest(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *UnaryTestArgs:
		success, err := handler.(pbapi.Mock).UnaryTest(ctx, s.Req)
		if err != nil {
			return err
		}
...
var UnaryTestArgs_Req_DEFAULT *pbapi.MockReq

func (p *UnaryTestArgs) GetReq() *pbapi.MockReq {
	if !p.IsSetReq() {
...
type UnaryTestResult struct {
	Success *pbapi.MockResp
}

var UnaryTestResult_Success_DEFAULT *pbapi.MockResp

func (p *UnaryTestResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(pbapi.MockResp)
	}
...
func (p *UnaryTestResult) GetSuccess() *pbapi.MockResp {
	if !p.IsSetSuccess() {
...
func clientStreamingTestHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	return handler.(pbapi.Mock).ClientStreamingTest(stream)
}
...
func (x *mockClientStreamingTestClient) Send(m *pbapi.MockReq) error {
	return x.Stream.SendMsg(m)
}
func (x *mockClientStreamingTestClient) CloseAndRecv() (*pbapi.MockResp, error) {
	if err := x.Stream.Close(); err != nil {
		return nil, err
	}
	m := new(pbapi.MockResp)
...
func (x *mockClientStreamingTestServer) SendAndClose(m *pbapi.MockResp) error {
	return x.Stream.SendMsg(m)
}

func (x *mockClientStreamingTestServer) Recv() (*pbapi.MockReq, error) {
	m := new(pbapi.MockReq)
	return m, x.Stream.RecvMsg(m)
}
...
var ClientStreamingTestArgs_Req_DEFAULT *pbapi.MockReq

func (p *ClientStreamingTestArgs) GetReq() *pbapi.MockReq {
	if !p.IsSetReq() {
...
var ClientStreamingTestResult_Success_DEFAULT *pbapi.MockResp
...
func (p *ClientStreamingTestResult) GetSuccess() *pbapi.MockResp {
	if !p.IsSetSuccess() {
...
func serverStreamingTestHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	return handler.(pbapi.Mock).ServerStreamingTest(req, stream)
}
...
func (x *mockServerStreamingTestClient) Recv() (*pbapi.MockResp, error) {
	m := new(pbapi.MockResp)
	return m, x.Stream.RecvMsg(m)
}
...
func (x *mockServerStreamingTestServer) Send(m *pbapi.MockResp) error {
	return x.Stream.SendMsg(m)
}
...
var ServerStreamingTestArgs_Req_DEFAULT *pbapi.MockReq

func (p *ServerStreamingTestArgs) GetReq() *pbapi.MockReq {
	if !p.IsSetReq() {
...
var ServerStreamingTestResult_Success_DEFAULT *pbapi.MockResp
...
func (p *ServerStreamingTestResult) GetSuccess() *pbapi.MockResp {
	if !p.IsSetSuccess() {
...
func bidirectionalStreamingTestHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	return handler.(pbapi.Mock).BidirectionalStreamingTest(stream)
}
...
func (x *mockBidirectionalStreamingTestClient) Send(m *pbapi.MockReq) error {
	return x.Stream.SendMsg(m)
}
func (x *mockBidirectionalStreamingTestClient) Recv() (*pbapi.MockResp, error) {
	m := new(pbapi.MockResp)
	return m, x.Stream.RecvMsg(m)
}
...
func (x *mockBidirectionalStreamingTestServer) Send(m *pbapi.MockResp) error {
	return x.Stream.SendMsg(m)
}

func (x *mockBidirectionalStreamingTestServer) Recv() (*pbapi.MockReq, error) {
	m := new(pbapi.MockReq)
	return m, x.Stream.RecvMsg(m)
}
...
var BidirectionalStreamingTestArgs_Req_DEFAULT *pbapi.MockReq

func (p *BidirectionalStreamingTestArgs) GetReq() *pbapi.MockReq {
	if !p.IsSetReq() {
...
var BidirectionalStreamingTestResult_Success_DEFAULT *pbapi.MockResp
...
func (p *BidirectionalStreamingTestResult) GetSuccess() *pbapi.MockResp {
	if !p.IsSetSuccess() {
...
func (p *kClient) UnaryTest(ctx context.Context, Req *pbapi.MockReq) (r *pbapi.MockResp, err error) {
...
func (p *kClient) ServerStreamingTest(ctx context.Context, req *pbapi.MockReq) (Mock_ServerStreamingTestClient, error) {
	streamClient, ok := p.c.(client.Streaming)
	if !ok {
		return nil, fmt.Errorf("client not support streaming")
	}
