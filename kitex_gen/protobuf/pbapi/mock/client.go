...
type Client interface {
	UnaryTest(ctx context.Context, Req *pbapi.MockReq, callOptions ...callopt.Option) (r *pbapi.MockResp, err error)
	ClientStreamingTest(ctx context.Context, callOptions ...callopt.Option) (stream Mock_ClientStreamingTestClient, err error)
	ServerStreamingTest(ctx context.Context, Req *pbapi.MockReq, callOptions ...callopt.Option) (stream Mock_ServerStreamingTestClient, err error)
...
type StreamClient interface {
	...
	ServerStreamingTest(ctx context.Context, Req *pbapi.MockReq, callOptions ...streamcall.Option) (stream Mock_ServerStreamingTestClient, err error)
...
type Mock_ClientStreamingTestClient interface {
	streaming.Stream
	Send(*pbapi.MockReq) error
	CloseAndRecv() (*pbapi.MockResp, error)
}

type Mock_ServerStreamingTestClient interface {
	streaming.Stream
	Recv() (*pbapi.MockResp, error)
}
...
func (p *kMockClient) UnaryTest(ctx context.Context, Req *pbapi.MockReq, callOptions ...callopt.Option) (r *pbapi.MockResp, err error) {
...
func (p *kMockClient) ServerStreamingTest(ctx context.Context, Req *pbapi.MockReq, callOptions ...callopt.Option) (stream Mock_ServerStreamingTestClient, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
...
func (p *kMockStreamClient) ServerStreamingTest(ctx context.Context, Req *pbapi.MockReq, callOptions ...streamcall.Option) (stream Mock_ServerStreamingTestClient, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, streamcall.GetCallOptions(callOptions))
	return p.kClient.ServerStreamingTest(ctx, Req)
}
