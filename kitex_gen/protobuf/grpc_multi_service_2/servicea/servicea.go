...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	...
	handlerType := (*grpc_multi_service_2.ServiceA)(nil)
...
func echoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	stream := &serviceAEchoServer{st}
	return handler.(grpc_multi_service_2.ServiceA).Echo(stream)
}

type serviceAEchoClient struct {
	streaming.Stream
}

func (x *serviceAEchoClient) DoFinish(err error) {
...
func (x *serviceAEchoClient) Send(m *grpc_multi_service_2.Request) error {
	return x.Stream.SendMsg(m)
}
func (x *serviceAEchoClient) Recv() (*grpc_multi_service_2.Reply, error) {
	m := new(grpc_multi_service_2.Reply)
	return m, x.Stream.RecvMsg(m)
}

type serviceAEchoServer struct {
	streaming.Stream
}

func (x *serviceAEchoServer) Send(m *grpc_multi_service_2.Reply) error {
	return x.Stream.SendMsg(m)
}

func (x *serviceAEchoServer) Recv() (*grpc_multi_service_2.Request, error) {
	m := new(grpc_multi_service_2.Request)
	return m, x.Stream.RecvMsg(m)
}
...
func (p *EchoArgs) Unmarshal(in []byte) error {
	msg := new(grpc_multi_service_2.Request)
...
var EchoArgs_Req_DEFAULT *grpc_multi_service_2.Request

func (p *EchoArgs) GetReq() *grpc_multi_service_2.Request {
	if !p.IsSetReq() {
...
type EchoResult struct {
	Success *grpc_multi_service_2.Reply
}

var EchoResult_Success_DEFAULT *grpc_multi_service_2.Reply

func (p *EchoResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(grpc_multi_service_2.Reply)
	}
...
func (p *EchoResult) Unmarshal(in []byte) error {
	msg := new(grpc_multi_service_2.Reply)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *EchoResult) GetSuccess() *grpc_multi_service_2.Reply {
	if !p.IsSetSuccess() {
...
func (p *EchoResult) SetSuccess(x interface{}) {
	p.Success = x.(*grpc_multi_service_2.Reply)
}
...
func (p *kClient) Echo(ctx context.Context) (ServiceA_EchoClient, error) {
	...
	stream := &serviceAEchoClient{res.Stream}
	return stream, nil
}
