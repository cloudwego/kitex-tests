...
type ServiceCEcho1Args struct {
	Req *Request `thrift:"req,1" frugal:"1,default,Request" json:"req"`
}

func NewServiceCEcho1Args() *ServiceCEcho1Args {
	return &ServiceCEcho1Args{}
}

func (p *ServiceCEcho1Args) InitDefault() {
}

var ServiceCEcho1Args_Req_DEFAULT *Request

func (p *ServiceCEcho1Args) GetReq() (v *Request) {
	if !p.IsSetReq() {
		return ServiceCEcho1Args_Req_DEFAULT
	}
	return p.Req
}
func (p *ServiceCEcho1Args) SetReq(val *Request) {
	p.Req = val
}

func (p *ServiceCEcho1Args) IsSetReq() bool {
	return p.Req != nil
}

func (p *ServiceCEcho1Args) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ServiceCEcho1Args(%+v)", *p)
}

var fieldIDToName_ServiceCEcho1Args = map[int16]string{
	1: "req",
}

type ServiceCEcho1Result struct {
	Success *Response `thrift:"success,0,optional" frugal:"0,optional,Response" json:"success,omitempty"`
}

func NewServiceCEcho1Result() *ServiceCEcho1Result {
	return &ServiceCEcho1Result{}
}

func (p *ServiceCEcho1Result) InitDefault() {
}

var ServiceCEcho1Result_Success_DEFAULT *Response

func (p *ServiceCEcho1Result) GetSuccess() (v *Response) {
	if !p.IsSetSuccess() {
		return ServiceCEcho1Result_Success_DEFAULT
	}
	return p.Success
}
func (p *ServiceCEcho1Result) SetSuccess(x interface{}) {
	p.Success = x.(*Response)
}

func (p *ServiceCEcho1Result) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ServiceCEcho1Result) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ServiceCEcho1Result(%+v)", *p)
}

var fieldIDToName_ServiceCEcho1Result = map[int16]string{
	0: "success",
}
